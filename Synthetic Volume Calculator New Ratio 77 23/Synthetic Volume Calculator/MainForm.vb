Public Class MainForm
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        Try
            ...
            dblbaseA = Math.Round(Val((dblgrams / 25) * 19.25), 3)
            dblCatB = Math.Round(Val((dblgrams / 25) * 5.75), 3)

            ' Display the answer to the labels
            lblAnswer.Text = "Total kit = " & dblgrams.ToString("F3") & " Kg"
            lblBaseA.Text = "Base A = " & dblbaseA.ToString("F3") & "  Kg"
            lblCatalystB.Text = "Catalyst B = " & dblCatB.ToString("F3") & " Kg"
    ...
    Private Sub pdPrint_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pdPrint.PrintPage
        ...
        If lblAnswer.Visible Then
            e.Graphics.DrawString(txtPartDescripton.Text, New Font("Times New Roman", 18, FontStyle.Underline), Brushes.Black, 10, 10)
            ...
            e.Graphics.DrawString("Synthetic Volume Calculator Application  " & dtmSystemDate, New Font("Times New Roman", 8, FontStyle.Regular), Brushes.Black, 10, 400)
        End If


        If lblAnswerwithTAF.Visible Then
            e.Graphics.DrawString("Totals with TAF of " & txtPercent.Text & "%", New Font("Times New Roman", 16, FontStyle.Italic), Brushes.Black, 10, 210)
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        ' pdPrint.PrinterSettings = pdDialog.PrinterSettings
        ' pdPrint.Print()
    ...
    Private Sub sqftBtn_Click(sender As Object, e As EventArgs) Handles sqftBtn.Click
        sqftForm.Show()
    End Sub
End Class
